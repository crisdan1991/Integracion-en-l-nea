...
Levantar proyecto en spring-camel

mvn.cmd  spring-boot:run   

Levantar proyecto empresa123
go run main.go

Levantar proyecto empresaXYZ
python -m venv proyectofpy
python install -r requirements.txt
pythom main.py


para utilizar los servicios importar los servicios del postman
